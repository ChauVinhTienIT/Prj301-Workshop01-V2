...
<html>
    ...
    <body>
        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">${pageContent}</h1>
                    <p class="lead fw-normal text-white-50 mb-0">Take your life for a better!</p>
                </div>
            </div>
        </header>
        <!-- Section-->
                        ...
                        <c:forEach items="${productList}" var="product">
                            <div class="col mb-5">
                                <div class="card h-100">
                                    ...
                                    <!-- Product image-->
                                    <img class="card-img-top" src=".${product.getProductImage()}" alt="..." />
                                    <!-- Product details-->
                                    ...
                                    <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                        <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="home-page?action=detail&productId=${product.getProductId()}">Detail</a></div>
                                    </div>
                                </div>
                            </div>
                        </c:forEach>
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white">Copyright &copy; Chau Vinh Tien Website 2024 - PRJ</p></div>
        </footer>
        <!-- Bootstrap core JS-->
